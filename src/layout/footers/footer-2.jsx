...
const footer_content = {
    ...
    phone: "+91 8265915605",
    email: "letstalk@netfairsolutions.com",
            ...
            <div className="row">
               <div className="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div className="tp-footer__widget footer-widget-2 footer-col-2-1">
                     ...
                     <Link style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}  href="/">
  <img src='favicon.png' style={{ width: 64, height: 64 }} alt="theme-pure" />
  <span style={{ fontWeight: 'bold', color: 'black', marginLeft: '0.5rem' }}>Netfair Solutions</span>
</Link>
                     </div>
